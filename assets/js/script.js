...
// array to story the task data in
var tempArr = [];

// made the element sortable
...
$(".list-group").on("click", "p", function() {
  ...
  // replace p element witha new textarea
...
$(".list-group").on("blur", "input[type='text']", function() {
  ...
  // get parent ul's id attribute || get status type and position in the list
  var status = $(this)
  .closest(".list-group")
  .attr("id")
  .replace("list-", "");
